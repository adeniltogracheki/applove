...
const Chat: React.FC = () => {
  return (
    <div className="animate-fade-in flex flex-col">
      ...
      <p className="text-center text-purple-300 mb-6">Nosso cantinho para conversar.</p>
      
      <div className="flex-grow bg-[#1f1f3a]/70 border border-purple-500/30 rounded-2xl shadow-lg p-4 flex flex-col justify-end min-h-[50vh]">
      ...
      <div className="mt-4 flex gap-2">
        ...
        />
        <button className="bg-purple-600 text-white p-3 rounded-full hover:bg-purple-500 transition shadow-[0_0_15px_rgba(147,51,234,0.5)]">
          <Send size={20} />
        </button>
      </div>
    </div>
